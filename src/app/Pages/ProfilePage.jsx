      ...
      <div className="min-h-screen flex flex-col">
        ...
        <div className="body bg-slate-400 grid place-items-stretch py-2 p-4 box-content">
          <div className="min-h-[75vh] bg-slate-300 rounded-sm flex flex-col items-center content-center shadow-lg">
            <div className="bg-[#ffb703] m-8 w-[20rem] sm:w-[32rem] md:w-[48rem] h-[8rem] p-10 px-4 sm:p-10 rounded-md text-black text-center sm:text-2xl md:text-4xl shadow-lg font-semibold mt-36 hover:scale-105 transform duration-300 ease-in-out hover:shadow-2xl hover:border-2 hover:border-slate-200">
