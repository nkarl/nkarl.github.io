...
In this verse, the parallel is drawn between the two symbols $S_1$ and $S_2$. $T_i$ are their modifiers. The word "faith" itself is part of a leading phrase. It is tempting at first to parallelize "faith" and "work" here, but that's not the right way to read this verse as shown in the graph above.
