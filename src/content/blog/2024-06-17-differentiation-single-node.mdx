...
- The components:
    - the <span style="background:#97BEEE;padding:0.125em;border-radius:0.25em">&nbsp;Node&nbsp;</span>, the <span style="background:#F4C111;padding:0.125em;border-radius:0.25em">&nbsp;Forward&nbsp;</span> chain, the <span style="background:#26A169;padding:0.125em;border-radius:0.25em">&nbsp;Reverse&nbsp;</span> chain
